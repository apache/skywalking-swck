...
Please follow step 1 to 3 in [getting started](../setup/getting-started.md) to create a cluster.
...
events:
  - uuid: 1d5bfe48-bc8d-4f5a-9680-188f59793459
    ...
    name: Pulled
    type: Normal
    message: Successfully pulled image "apache/skywalking-oap-server:11.0.0" in 6m4.108914335s
    parameters: [ ]
  ...
  - uuid: 28f0d004-befe-4c27-a7b7-dfdc4dd755fa
    ...
    name: Pulling
    type: Normal
    message: Pulling image "apache/skywalking-oap-server:11.0.0"
    parameters: [ ]
