...
Then add [agent configuration](../setup/java-agent-injector.md#use-annotations-to-overlay-default-agent-configuration)
and [sidecar configuration](../setup/java-agent-injector.md#configure-sidecar) to annotations as below.
